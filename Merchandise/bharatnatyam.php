...
$result = $conn->query("SELECT * FROM products WHERE category='bharatnatyam'");
...
<body>
    ...
    <p id="RP">List Of Bharatnatyam Products</p>
    <hr>
    ...
    <footer>
        <p>
            ...
            <i class="fa-solid fa-phone"></i> 9987313390 &nbsp;&nbsp;
